"""
training.py — Pipeline Training DistilBERT (End-to-End)
========================================================
Jalankan:
    python training.py
    python training.py --lr 3e-5 --optimizer adamw --weight_decay 0.01 --scheduler linear
...
def parse_args():
    ...
    Contoh penggunaan:
        python training.py
        python training.py --lr 3e-5 --optimizer adam --weight_decay 0.01 --scheduler cosine
    """
    parser = argparse.ArgumentParser(description="Fine-tuning DistilBERT untuk klasifikasi sentimen")

    parser.add_argument(
        "--lr",
        type=float,
        default=5e-5,
        help="Learning rate awal (default: 5e-5)",
    )
    parser.add_argument(
        "--optimizer",
        type=str,
...
def main(
    ...
    Args:
        lr           : Learning rate awal (contoh: 5e-5, 3e-5).
    ...
    print(f"Metrics: plots/training_metrics.csv")
    print(f"Plots: plots/")
